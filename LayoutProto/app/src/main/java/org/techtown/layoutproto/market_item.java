...
public class market_item extends Fragment {
    ...
    public static market_item newInstance() {
        market_item fragment = new market_item();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button_s = view.findViewById(R.id.plus_b);
